...
i.e. "/lib64/ld-linux.so". This paper is about creating an alternate program
interpreter which is loaded prior to the dynamic linker itself.
...
'PT_INTERP' which holds the path to the LDSO, usually "/lib64/ld-linux.so".
...
musl-libc and a slightly modified version of libelfmaster.
